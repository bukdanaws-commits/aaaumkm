/**
 * Seed Production Marketplace Data
 * 
 * This script seeds the production database with 50 marketplace products
 * and 10 random users. It uses the production DATABASE_URL.
 * 
 * Usage:
 * DATABASE_URL="postgresql://..." npx tsx scripts/seed-production-marketplace.ts
 */
...
const unsplashImages = [
  ...
  'https://images.unsplash.com/photo-1588872657840-790ff3bde08c?w=600&h=400&fit=crop',
  'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=600&h=400&fit=crop',
  'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=600&h=400&fit=crop',
  'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600&h=400&fit=crop',
  'https://images.unsplash.com/photo-1551028719-00167b16ebc5?w=600&h=400&fit=crop',
  ...
  'https://images.unsplash.com/photo-1595777707802-21b287e3fbf9?w=600&h=400&fit=crop',
  ...
  'https://images.unsplash.com/photo-1597318972826-c0e0c1e8e8c0?w=600&h=400&fit=crop',
  'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=600&h=400&fit=crop',
  'https://images.unsplash.com/photo-1587049352861-d92d19620e76?w=600&h=400&fit=crop',
  'https://images.unsplash.com/photo-1599599810694-b5ac4dd64b73?w=600&h=400&fit=crop',
]

async function seedProductionMarketplace() {
  console.log('\n🌱 Seeding Production Marketplace Data')
  ...
  try {
      ...
      if (!profile) {
        profile = await prisma.profile.create({
          data: {
            ...
            province: ['DKI Jakarta', 'Jawa Barat', 'Jawa Timur', 'Sumatera Utara', 'DI Yogyakarta'][i % 5],
            provinceId: ['31', '32', '35', '12', '34'][i % 5],
            regencyId: ['3171', '3273', '3578', '1201', '3471'][i % 5],
            isVerified: true,
            isKycVerified: true,
          },
        })
    ...
    for (let i = 0; i < products.length; i++) {
      ...
      const uniqueSlug = `${baseSlug}-prod-${i}-${Math.random().toString(36).substring(7)}`
    ...
    console.log('═'.repeat(60))
    console.log('🎉 Production marketplace data seeded successfully!')
    console.log('')
    console.log('Summary:')
